...
<script>
import clip from '@/content/components/admin/utils/clipboard' // use clipboard directly
import clipboard from '@/content/components/admin/directive/clipboard/index.js' // use clipboard by v-directive
