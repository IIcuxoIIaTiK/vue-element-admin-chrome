...
<script>
import PanThumb from '@/content/components/admin/components/PanThumb'
import MdInput from '@/content/components/admin/components/MDinput'
import Mallki from '@/content/components/admin/components/TextHoverEffect/Mallki'
import DropdownMenu from '@/content/components/admin/components/Share/dropdownMenu'
import waves from '@/content/components/admin/directive/waves/index.js' // 水波纹指令
