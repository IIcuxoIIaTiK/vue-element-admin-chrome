...
<script>
import img404 from '@/components/admin-lite/assets/404_images/404.png'
import img404Cloud from '@/components/admin-lite/assets/404_images/404_cloud.png'
...
export default {
  ...
  computed: {
    message () {
      return 'Trump said that you can\'t enter this page......'
    }
  }
}
</script>
