          ...
          <div class="columns">
            <div class="column is-8 is-offset-3" style="display: flex; align-items: center;">
              ...
              <div class="is-pulled-left" style="text-align: left">
                <h1 class="title text-medium-grey" style="margin-bottom: .5rem">Stepper</h1>
                <hr class="is-marginless">
                <h2 class="subtitle text-light-grey" style="margin-top: .5rem">A Vue Component
                  <span class="is-pulled-right">
                    <!-- Place this tag where you want the button to render. -->
                    <a class="github-button" href="https://github.com/PygmySlowLoris/vue-stepper" data-icon="octicon-star" data-size="large" aria-label="Star PygmySlowLoris/vue-stepper on GitHub">Star</a>
                  </span>
                </h2>
              </div>
            </div>
    ...
    <footer class="footer">
      <div class="container">
        <div class="content has-text-centered">
          <p>
            <strong>Stepper Vue Component</strong> by <a :href="teamUrl">Pygmy Team</a>.
          </p>
          <p>
