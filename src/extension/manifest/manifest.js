...
module.exports = {
  ...
  default_locale: 'en',
  manifest_version: 2,
  content_security_policy: "default-src 'self'; script-src 'self' 'unsafe-eval' https://ssl.dev:3001 https://localhost:3000 http://localhost:3000 'unsafe-eval'; connect-src http://localhost:3000 ws://localhost:3000 ws://localhost:35729 ws://localhost:3000 ws://localhost:9090; style-src * 'self' 'unsafe-inline'; font-src 'self'; img-src 'self' data:; object-src 'self'",
  //content_security_policy: "script-src 'self' 'unsafe-eval' https://fonts.googleapis.com; style-src 'self' 'unsafe-inline'; connect-src 'self'; font-src 'self' https://fonts.googleapis.com; object-src 'self'",
