<template>
  <footer class="footer">
    <div class="item">
      <i @click="opGallery" class="material-icons">images</i>
    </div>
    <div class="item" v-if="bing && bing.status">
      <i @click="opImageInfo" class="material-icons">error_outline</i>
      <Info :show="info" :background = "background" @dismiss ="opImageInfo" />
    </div>
    <Background :background="background" />
    <Gallery v-show="gallery" :images="images" @setImage="setImage"  @dismiss="opGallery" />
  </footer>
</template>
