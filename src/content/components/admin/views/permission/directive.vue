...
<script>
import permission from '@/content/components/admin/directive/permission/index.js' // 权限判断指令
import checkPermission from '@/content/components/admin/utils/permission' // 权限判断函数
