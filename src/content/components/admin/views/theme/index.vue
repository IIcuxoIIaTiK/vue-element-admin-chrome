...
<script>
import { toggleClass } from '@/content/components/admin/utils'
import '@/content/components/admin/assets/custom-theme/index.css' // the theme changed version element-ui css
